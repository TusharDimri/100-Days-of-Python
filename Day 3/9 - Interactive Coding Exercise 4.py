...
true = combine.count('t') + combine.count('r') + combine.count('u') + combine.count('e') 
love = combine.count('l') + combine.count('o') + combine.count('v') + combine.count('e') 
...
elif love_percentage <= 50 and love_percentage >= 40:
